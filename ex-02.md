...
1. Since you will now be containerizing the different microservices, you will also need to create a new Azure Container Registry (ACR) instance for holding your container images. Edit MYACR as **acrpetclinics<inject key="DeploymentID" enableCopy="false" />** and run this command.
